 ...
 * @author scben
 */
public class BienvenidaRecepcionista extends javax.swing.JFrame {

    /**
     * Creates new form BienvenidaRecepcionista
     */
    public BienvenidaRecepcionista() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BienvenidaRecepcionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BienvenidaRecepcionista().setVisible(true);
            }
        });
    }
