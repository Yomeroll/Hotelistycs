...
public class BienvenidaAdmin extends javax.swing.JFrame {
    ...
    public void resetTxtNombreU(){
        if (txt_nombre_U.getText().isEmpty()){
            ...
            txt_nombre_U.setForeground(Color.red);
        }
    }
    ...
    public void resetTxtPat(){
        if(txt_apellido_PU.getText().isEmpty()){
            ...
            txt_apellido_PU.setForeground(Color.red);
        }
    }
    ...
    public void resetTxtMat(){
        if(txt_apellido_MU.getText().isEmpty()){
            ...
            txt_apellido_MU.setForeground(Color.red);
        }
    }
    ...
    public int validarCambio(){
        int confirmar;
        
        if(String.valueOf(txt_Password.getPassword()).equals("admin")){
            JOptionPane.showMessageDialog(this, "Debes cambiar la contraseña");
            txt_PasswordConfirm.setText("********");
            txt_PasswordConfirm.setForeground(new Color(204,204,204));
            txt_Password.setText("");
            txt_Password.requestFocus();
            confirmar=0;
        }else if ((String.valueOf(txt_Password.getPassword())).equals(String.valueOf(txt_PasswordConfirm.getPassword())))
        {
            confirmar=1;
        }else{
            
            JOptionPane.showMessageDialog(this, "Tu contraseña no coincide");
            txt_PasswordConfirm.setText("");
    ...
    void editar(){
        String user_name=txt_Usuario.getText();
        String nombre=txt_nombre_U.getText();
        String apellido_pat=txt_apellido_PU.getText();
        String apellido_mat=txt_apellido_MU.getText();
        String contra=String.valueOf(txt_Password.getPassword());
        
        sql.editarCuenta("administrador", contra, user_name, nombre, apellido_pat, apellido_mat, "admin");
